...
**Important:** Please **do NOT click the exit button** shown below. This will actually exit and end your VNC session (as oppose to simply disconnecting). We will have to restart your SlicerMorphCloud instance one more time (with new address and password), and you will have to redo the configuration steps below.   
